...
<head>
  ...
  <style>
    ...
    * {
    ...
    .r { text-align: right; }
    .b { font-weight: bold; }
    .logo-wrap { text-align: center; margin: 0 0 3px; }
    .logo {
      width: 42px;
      height: 42px;
      object-fit: contain;
    ...
    .title { font-size: 14px; font-weight: 900; letter-spacing: 0.2px; margin: 1px 0 2px; text-transform: uppercase; }
    .sub { font-size: 8.5px; margin: 1px 0; color: #000; }
    .tag { font-size: 9.5px; font-weight: 700; margin: 3px 0 2px; }
    .meta { font-size: 9px; margin: 3px 0 2px; }
    .line { border-top: 1px dashed #000; margin: 3px 0; }
    table { width: 100%; border-collapse: collapse; font-size: 9px; table-layout: fixed; }
    th, td { padding: 1.5px 1px; vertical-align: top; word-break: break-word; overflow-wrap: anywhere; }
    th {
      font-size: 8.5px;
      font-weight: 700;
    ...
    .total-row { font-size: 10px; font-weight: 900; }
    .thanks { font-size: 10px; font-weight: 900; margin-top: 4px; }
